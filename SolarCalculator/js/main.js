...
function calculatePanel() {
	var userChoise = document.forms.solarForm.panel.selectedIndex;
	var panelOptions = document.forms.solarForm.panel.options;
	var power = panelOptions[userChoise].value;
	var name = panelOptions[userChoise].text;
	var x = [power, name];
	return x;
}//end of function
...
function calculateSolar() {
	...
	feedback += "<h2>Aditional Details</h2>";
	...
	feedback += "<p>The "+Math.round(panelName)+"  panel you selected generates about  "+Math.round(panelOutput)+"  watts per hour.</p>";
